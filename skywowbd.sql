...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-06-19 16:55:36',NULL),('diagnostics.include_raw','OFF','2021-06-19 16:55:36',NULL),('ps_thread_trx_info.max_length','65535','2021-06-19 16:55:36',NULL),('statement_performance_analyzer.limit','100','2021-06-19 16:55:36',NULL),('statement_performance_analyzer.view',NULL,'2021-06-19 16:55:36',NULL),('statement_truncate_len','64','2021-06-19 16:55:36',NULL);
...
-- Dump completed on 2021-06-28 20:23:25
-- MySQL dump 10.13  Distrib 8.0.25, for Win64 (x86_64)
--
-- Host: localhost    Database: kulba_rgr
-- ------------------------------------------------------
-- Server version	8.0.25
...
CREATE TABLE `additional` (
  `idAdditional` int NOT NULL AUTO_INCREMENT,
  `idTovar1` int NOT NULL,
  `idTovar2` int NOT NULL,
  PRIMARY KEY (`idAdditional`),
  KEY `tovar1_idx` (`idTovar1`),
  KEY `tovar2_idx` (`idTovar2`),
  CONSTRAINT `tovar1` FOREIGN KEY (`idTovar1`) REFERENCES `tovar` (`idTovar`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tovar2` FOREIGN KEY (`idTovar2`) REFERENCES `tovar` (`idTovar`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `additional` VALUES (1,1,3),(2,1,4);
...
CREATE TABLE `dolzhnost` (
  `idDolzhnost` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dolzhnost` VALUES (1,'Управляющий'),(2,'Продавец-консультант'),(3,'Консультант'),(4,'Администратор');
...
CREATE TABLE `dostavka` (
  `idDostavka` int NOT NULL AUTO_INCREMENT,
  `idKlient` int NOT NULL,
  `Adress` varchar(45) NOT NULL,
  `Data` timestamp NULL DEFAULT NULL,
  `idZakazl` int NOT NULL,
  PRIMARY KEY (`idDostavka`),
  KEY `dostavka_idx` (`idKlient`),
  KEY `zakaz_idx` (`idZakazl`),
  CONSTRAINT `dostavka` FOREIGN KEY (`idKlient`) REFERENCES `klient` (`idKlient`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `zakaz` FOREIGN KEY (`idZakazl`) REFERENCES `zakaz` (`idZakaz`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `dostavka` VALUES (1,1,'Ленинградский 21 к 4','2021-06-25 13:25:45',1),(2,2,'Ломоносова 25','2021-06-25 13:25:45',2),(6,1,'No','0000-00-00 00:00:00',9);
/*!40000 ALTER TABLE `dostavka` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `kategoriya_tovarov`
--

DROP TABLE IF EXISTS `kategoriya_tovarov`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kategoriya_tovarov` (
  `idKategoriya_Tovarov` int NOT NULL AUTO_INCREMENT,
  `Nazvanie` varchar(45) NOT NULL,
  `Opisanie` varchar(45) NOT NULL,
  PRIMARY KEY (`idKategoriya_Tovarov`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `kategoriya_tovarov`
--

LOCK TABLES `kategoriya_tovarov` WRITE;
/*!40000 ALTER TABLE `kategoriya_tovarov` DISABLE KEYS */;
INSERT INTO `kategoriya_tovarov` VALUES (1,'Стол','Стол'),(2,'Стул','Стул'),(3,'Шкаф','Товар для хранения вещей'),(4,'Комод','Товар для хранения вещей');
/*!40000 ALTER TABLE `kategoriya_tovarov` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `klient` VALUES (1,'Кондратьева','Мария','Сергеевна','login1','password1'),(2,'Колесник','Максим','Евгеньевич','login2','password2'),(3,'Гришин','Егор','Витальевич','login3','password3');
...
INSERT INTO `manufacturer` VALUES (1,'Хофф'),(2,'ДЕПО'),(3,'Лазурит'),(4,'Арх-Мебель');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `secret` (
  `idSecrets` int NOT NULL AUTO_INCREMENT,
  `idSotrudnika` int NOT NULL,
  `password` varchar(10) NOT NULL,
  PRIMARY KEY (`idSecrets`),
  KEY `sotrudnik_idx` (`idSotrudnika`),
  CONSTRAINT `sotrudnik` FOREIGN KEY (`idSotrudnika`) REFERENCES `sotrudnik` (`idSotrudnik`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `secret` VALUES (1,1,'password1'),(2,2,'password2'),(3,3,'password3');
/*!40000 ALTER TABLE `secret` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `sostavzakaza`
--

DROP TABLE IF EXISTS `sostavzakaza`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sostavzakaza` (
  `idSostavzakaza` int NOT NULL AUTO_INCREMENT,
  `idZakaz` int NOT NULL,
  `idTovar` int NOT NULL,
  `Kolichestvo` int NOT NULL,
  PRIMARY KEY (`idSostavzakaza`),
  KEY `sostav_zakaza_tovar_idx` (`idTovar`),
  KEY `sostav_zakaza_zakaz_idx` (`idZakaz`),
  CONSTRAINT `sostav_zakaza_tovar` FOREIGN KEY (`idTovar`) REFERENCES `tovar` (`idTovar`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `sostav_zakaza_zakaz` FOREIGN KEY (`idZakaz`) REFERENCES `zakaz` (`idZakaz`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sostavzakaza`
--

LOCK TABLES `sostavzakaza` WRITE;
/*!40000 ALTER TABLE `sostavzakaza` DISABLE KEYS */;
INSERT INTO `sostavzakaza` VALUES (1,1,1,1),(2,2,2,1),(3,3,3,1),(6,9,3,1);
/*!40000 ALTER TABLE `sostavzakaza` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `sotrudnik` (
  ...
  `Stazh` timestamp NULL DEFAULT NULL,
  `login` varchar(45) NOT NULL,
  PRIMARY KEY (`idSotrudnik`),
  KEY `dolzhnost_idx` (`idDolzhnost`),
  CONSTRAINT `dolzhnost` FOREIGN KEY (`idDolzhnost`) REFERENCES `dolzhnost` (`idDolzhnost`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sotrudnik` VALUES (1,'Разманов','Кирилл','Игоревич',1,'2021-06-25 13:25:45','kirill1'),(2,'Дубинин','Кирилл','Александрович',3,'2021-06-25 13:25:45','kirill2'),(3,'Кульба','Георгий','Васильевич',4,'2021-06-25 13:25:45','skywow');
...
CREATE TABLE `tovar` (
  ...
  `Izobrazhenie` text,
  `idKategoriya_Tovarov` int NOT NULL,
  `idManufacturer` int NOT NULL,
  `actual` int DEFAULT NULL,
  PRIMARY KEY (`idTovar`),
  KEY `kategoriya_svyaz_idx` (`idKategoriya_Tovarov`),
  KEY `tovar_manufacturer_idx` (`idManufacturer`),
  CONSTRAINT `kategoriya_svyaz` FOREIGN KEY (`idKategoriya_Tovarov`) REFERENCES `kategoriya_tovarov` (`idKategoriya_Tovarov`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tovar_manufacturer` FOREIGN KEY (`idManufacturer`) REFERENCES `manufacturer` (`idManufacturer`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tovar` VALUES (1,'Стол SKANDI','Вместительный стол',5700.00,'1-1.jpg;1-2.jpg;1-3.jpg;1-4.jpg',1,1,1),(2,'Стул AMALIA','Легкий и удобный стул',1800.00,'2-1.jpg;2-2.jpg;2-3.jpg;2-4.jpg',2,2,0),(3,'Шкаф SLIDE','Прочный и надежный шкаф',13500.00,'3-1.jpg;3-2.jpg;3-3.jpg;3-4.jpg',3,3,1),(4,'Комод OSLO','Удобный и стильный комод',2900.00,'4-1.jpg;4-2.jpg;4-3.jpg;4-4.jpg',3,4,1);
...
INSERT INTO `zakaz` VALUES (1,1.00,'1'),(2,2.00,'2'),(3,3.00,'3'),(9,13500.00,'ok');
